...
public class BookWebResource {
  ...
  public static class Templates {
    ...
    public static native TemplateInstance graph(String script);
  }
  ...
  @Path("graph")
  @Produces(MediaType.TEXT_HTML)
  public TemplateInstance graph() {
    return Templates.graph(SCRIPT);
  }

  // From https://gist.github.com/mbostock/1153292
  @Language("JavaScript")
